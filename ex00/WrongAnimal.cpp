...
WrongAnimal::WrongAnimal() : _wrong_type("WRONGANIMAL!!!") {
	...
	std::cout << COLOR_RED << this->_wrong_type << " CONSTRUCTOR WAS CALLED!!!" << COLOR_DEFAULT << std::endl;
}

WrongAnimal::WrongAnimal(std::string param_wrong_type) : _wrong_type(param_wrong_type) {
...
WrongAnimal::~WrongAnimal() {
	std::cout << COLOR_RED << this->_wrong_type << " WAS DESTROYED!!!" << COLOR_DEFAULT << std::endl;
}
...
void WrongAnimal::makeWrongSound() const {
	std::cout << COLOR_RED << "WRONG ANIMAL SOUND!!!" << COLOR_DEFAULT << std::endl;
}