...
WrongCat::WrongCat() : _wrong_type("WRONGCAT") {
    std::cout << COLOR_YELLOW << this->_wrong_type << " CONSTRUCTOR WAS CALLED"
...
WrongCat::~WrongCat() {
    std::cout << COLOR_YELLOW << this->_wrong_type << " WAS DESTROYED!!!"
              << COLOR_DEFAULT << std::endl;
}

std::string WrongCat::getWrongType(void) const { return this->_wrong_type; }
